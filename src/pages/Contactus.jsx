...
const ContactPage = () => {
  ...
  return (
    <div>
      <header className="backdrop-filter-saturate-blur bg-transparent fixed top-0 left-0 w-full z-50">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2">
          <div className="inline-flex items-center space-x-2">
            ...
            <span className="font-bold">TechyAvi</span>
          </div>
            ...
            <div className="w-auto p-8">
              <a href="#">
                <div className="inline-flex items-center">
                  ...
                  <span className="ml-4 text-lg font-bold">TechyAvi</span>
                </div>
              </a>
            </div>
            <div className="w-auto p-8">
